...
console.log(artist["Vincent Van Gough"])
...
function getArtistByIndex(artists, index) {
  return`${artists[index].id} is ${artists[index].name}`
}  
...
console.log(addArtist('30', 'Anthony', 1990-2020, 'Web Design', 'Caucasion', 'lorem ipsun'))
